...
function draw_chart(name, safe_name, folder, tie_breaker, center_sort, collapse,start_year) {
	...
	d3.xml(folder + ".xml", function(x) {
	    ...
	    */
	    ...
	    scenes.forEach(function(s) {
            ...
            //~ s.out_links.forEach(function(l) {
				//~ if (l.to.char_node) {
				    //~ last_scenes[last_scenes.length] = l.to;
				//~ }
			//~ });
			...
			*/
            ...
            //~ for (var i = 0; i < last_scenes.length; i++) {
			    //~ last_scenes[i].y = s.y + s.height/2.0 + i*text_height/2;
			//~ }
			    //~ //}
		    }    
	    });
    ...
    var svgyear = svg.append("text")
        .attr("x",margin.left+6+(i*duration_spacing+panel_shift)*panel_width) //scene.start*scene.duration+panel_shift)*panel_width
		.attr("y", 0)
        .attr("fill", "#fff")
...
dir = ".";
//~ draw_chart("NBA", "nba_off_skills", "NBAoff", true, true, false);
//~ draw_chart("NBA", "nba_off_skills", "NBA", true, true, false);
//~ draw_chart("NBA", "nba_off_skills", "NBA", true, true, false);
//~ draw_chart("NHL", "nhl_skills", "NHLdef", true, true, false);
//~ draw_chart("NHL", "nhl_skills", "NHLoff", true, true, false);
//~ draw_chart("NFL", "nfl_skills", "NFLoff", true, true, false);
draw_chart("NFL Defensive Skills", "nfl_def_skills", "NFL1", true, true, false,2000);
draw_chart("NFL Offensive Skills", "nfl_off_skills", "NFL0", true, true, false,2000);
draw_chart("NBA Defensive Skills", "nba_def_skills", "NBA1", true, true, false,2002);
draw_chart("NBA Offensive Skills", "nba_off_skills", "NBA0", true, true, false,2002);
